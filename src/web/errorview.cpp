...
void ErrorView::Draw() {
	if (AnBrowse::busy) {
		...
		UI::Texture(5, Display::height - 17.f, 16, 16, Icons::compile, (show && !showExec)? VisSystem::accentColor : white());
		...
		UI::Texture(42, Display::height - 17.f, 16, 16, Icons::exec, (show && showExec) ? VisSystem::accentColor : white());
